...
export const TIPO_EVENTO = [
  ...
  'caso.cancelado',
  'caso.patologista_atribuido',
  'caso.entrada_alterada',
  'caso.material_alterado',
  'material.recebido',
  'recipiente.recebido',
  ...
  'logistica.responsavel_alterado',
  'logistica.deslocamento_iniciado',
  'logistica.chegada_registrada',
  'logistica.material_retirado',
  'logistica.material_entregue',
  'logistica.servico_concluido',
  'logistica.nao_realizada',
  'logistica.reagendada',
  'logistica.ocorrencia_registrada',
  'logistica.divergencia_volumes',
  'logistica.rota_iniciada',
  'logistica.rota_encerrada',
  // M20 Financeiro (parcial) - producao do encarregado
  'producao.registrada',
  // M21 Biblioteca
  'biblioteca.documento_criado',
  'biblioteca.enviado_revisao',
  'biblioteca.revisao_concluida',
  'biblioteca.aprovado',
  'biblioteca.publicado',
  'biblioteca.obsoleto',
  'biblioteca.ciencia_confirmada',
  'biblioteca.feedback_recebido',
  'biblioteca.pesquisa_sem_resultado',
...
export const EVENTO_LABEL: Record<TipoEvento, string> = {
  ...
  'caso.patologista_atribuido': 'Lâmina destinada ao patologista',
  'caso.entrada_alterada': 'Data de entrada corrigida — prazo recontado',
  'caso.material_alterado': 'Amostras ou recipientes corrigidos',
  ...
  'logistica.responsavel_alterado': 'Responsável pela operação alterado',
  'logistica.deslocamento_iniciado': 'Encarregado a caminho',
  'logistica.chegada_registrada': 'Encarregado chegou ao local',
  'logistica.material_retirado': 'Material retirado',
  'logistica.material_entregue': 'Material entregue',
  'logistica.servico_concluido': 'Serviço logístico concluído',
  'logistica.nao_realizada': 'Operação não realizada',
  'logistica.reagendada': 'Operação reagendada',
  'logistica.ocorrencia_registrada': 'Ocorrência logística registrada',
  'logistica.divergencia_volumes': 'Volumes coletados diferem dos entregues',
  'logistica.rota_iniciada': 'Rota iniciada',
  'logistica.rota_encerrada': 'Rota encerrada',
  'producao.registrada': 'Produção do encarregado registrada',
  'biblioteca.documento_criado': 'Documento criado na Biblioteca',
  'biblioteca.enviado_revisao': 'Documento enviado para revisão',
  'biblioteca.revisao_concluida': 'Revisão do documento concluída',
  'biblioteca.aprovado': 'Documento aprovado',
  'biblioteca.publicado': 'Nova versão publicada',
  'biblioteca.obsoleto': 'Documento tornado obsoleto',
  'biblioteca.ciencia_confirmada': 'Leitura confirmada',
  'biblioteca.feedback_recebido': 'Feedback sobre documento',
  'biblioteca.pesquisa_sem_resultado': 'Pesquisa na Biblioteca sem resultado',
